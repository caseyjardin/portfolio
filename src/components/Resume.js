                      ...
                      <ul className="stack">
                        {
                          item.skills && item.skills.map((achievement, idx) => {
                            return(
                              <li key={`skill-${idx}`} className="specialization"><i className="far fa-check-square" /> {achievement}</li>
                            )
                          })
                        }
                      </ul>
                      ...
                      <ul className="achievements">
                        {
                          item.achievements && item.achievements.map((skill, idx) => {
                            return(
                              <li key={`skill-${idx}`} className="specialization"><i className="far fa-check-square" /> {skill}</li>
                            )
                          })
                        }
                      </ul>
